...
namespace AWSIM
{
    ...
    /// </summary>
    public class RsuReportRos2Publisher : MonoBehaviour
    {
        /// <summary>
        ...
        void FixedUpdate()
        {
            ...
            // VelocityReport
            var rosLinearVelocity = ROS2Utility.UnityToRosPosition(new Vector3(0,0,0));
            var rosAngularVelocity = ROS2Utility.UnityToRosPosition(new Vector3(0,0,0));
